...
public final class LocationConfig {
    ...
    public static final ModConfigSpec.BooleanValue ORE_CLUSTERS=BUILDER.comment("Include the original ore-cluster ticket when selecting small Nether locations. Disabling affects new chunks only.").define("SpawnOreClusterStructures",true);
