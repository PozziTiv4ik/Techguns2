...
public final class NetherAltarStructure extends SmallNetherStructure {
    ...
    @Override protected TemplateStructurePiece createPiece(StructureTemplateManager manager,BlockPos origin,int direction) { return new NetherAltarPiece(manager,origin,direction); }
