...
public final class NpcSpawnConfig {
    ...
    public static final ModConfigSpec.IntValue BANDIT_WEIGHT = BUILDER.comment("Original Bandit weight; available at danger level 2 or above.").defineInRange("SpawnWeightBandit",50,0,10000);
